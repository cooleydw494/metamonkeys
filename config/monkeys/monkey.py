...
class Monkey(BaseMonkey):
    ...
    # General
    WORK_PATH: OStr = "~/local-git/codemonkeys/codemonkeys"
    ...
    # Output
    OUTPUT_PATH: OStr = "~/local-git/codemonkeys/codemonkeys"
    OUTPUT_EXT: OStr = ".py"
    ...
    OUTPUT_CHECK_TEMP: OFloat = 0.7

    # Max Tokens
    MAIN_MAX_TOKENS: OInt = 5000
    SUMMARY_MAX_TOKENS: OInt = 5000
    OUTPUT_CHECK_MAX_TOKENS: OInt = 3000
